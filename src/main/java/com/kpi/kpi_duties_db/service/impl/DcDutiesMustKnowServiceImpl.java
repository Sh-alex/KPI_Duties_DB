...
public class DcDutiesMustKnowServiceImpl extends BaseServiceImpl<DcDutiesMustKnowEntity> implements DcDutiesMustKnowService{
    ...
    public List<DcDutiesMustKnowEntity> findByParams(String text, String sortDirection, Integer offset, Integer limit) {
        Criteria criteria = hibernateTemplate.getSessionFactory().getCurrentSession().createCriteria(DcDutiesMustKnowEntity.class);
        if (text != null) {
