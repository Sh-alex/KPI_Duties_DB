...
public class DcDutiesQualificationRequirementsServiceImpl extends BaseServiceImpl<DcDutiesQualificationRequirementsEntity> implements DcDutiesQualificationRequirementsService {
    ...
    public List<DcDutiesQualificationRequirementsEntity> findByParams(String text, String sortDirection, Integer offset, Integer limit) {
        Criteria criteria = hibernateTemplate.getSessionFactory().getCurrentSession().createCriteria(DcDutiesQualificationRequirementsEntity.class);
        if (text != null) {
