...
export default class FormEditOccupInfoNameSection extends Component {
    render() {
        let {
            ...
            clarificationFormGroupClass,
            clarifiedOccupFormGroupClass;

        if(nameFields.clarification)
        ...
        return (
            <div>
                ...
                { nameFields.clarifiedOccup && nameFields.clarification && (
                    <div className="row">
